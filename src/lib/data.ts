...
export const translations: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    serv_title_1: 'Технологии + креатив =',
    serv_title_em: 'предсказуемый результат.',
    s1_name: 'Нейровидео',
    ...
    work_label: 'ПРОЕКТЫ',
    work_title_1: 'Избранные',
    work_title_em: 'проекты',
    ...
    clients_title_em: 'клиенты',
    
    proc_label: 'КАК РАБОТАЕМ',
    proc_title_1: 'Продакшн',
    proc_title_em: 'в 4 этапа',
    p1_title: 'Фотореалистичное качество, полный контроль и точная интеграция продукта.', p1_text: '',
    p2_title: 'Собственная технологическая база и управляемый рабочий процесс.', p2_text: '',
    p3_title: 'Сильная команда ИИ-креаторов', p3_text: '',
    p4_title: 'Создание креативных концепций и сценариев.', p4_text: '',
    cta_t_1: 'Есть идея?',
    ...
    ct_success_title: 'Спасибо за заявку', ct_success_desc: 'Ваша заявка отправлена. С вами свяжутся в ближайшее время!',
    ct_lbl_services: 'Что вас интересует?', ct_lbl_name: 'Как вас зовут?', ct_ph_name: 'Имя',
    ct_lbl_email: 'Где вам ответить?', ct_ph_email: 'Email или Telegram (t.me/ник)',
    ...
    ct_name: 'Имя', ct_contact: 'Email или Telegram (t.me/ник)', ct_service: 'Что интересует',
  ...
  en: {
    ...
    serv_title_1: 'Technology + creativity =',
    serv_title_em: 'predictable results.',
    s1_name: 'AI Video',
    ...
    work_label: 'PROJECTS', work_title_1: 'Featured', work_title_em: 'projects',
    ...
    proc_label: 'HOW WE WORK', proc_title_1: 'Production', proc_title_em: 'in 4 steps',
    p1_title: 'Photorealistic quality, full control, and precise product integration.', p1_text: '',
    p2_title: 'In-house tech stack and managed pipeline.', p2_text: '',
    p3_title: 'Strong team of AI creators', p3_text: '',
    p4_title: 'Creation of creative concepts and scripts.', p4_text: '',
    ...
    ct_success_title: 'Thanks for reaching out', ct_success_desc: 'Your request has been sent. We will contact you shortly!',
    ct_lbl_services: "What's on the table?", ct_lbl_name: "What's your name?", ct_ph_name: 'Name',
    ct_lbl_email: 'Where should we reply?', ct_ph_email: 'Email or Telegram (t.me/username)',
    ...
    ct_name: 'Name', ct_contact: 'Email or Telegram (t.me/username)', ct_service: "What's on the table",
...
export const projects: Project[] = [
  ...
  { 
    ...
    cat: 'video', 
    year: 2026, 
    catLabel: { ru: 'Рилсы · eSIM-оператор', en: 'Reels · eSIM Operator' }, 
    grad: ['#2d1b3d','#5a3a7a'], 
    accent: '#ffc0cb', 
    type: 'splash', 
    ...
    description: {
      ...
      en: 'A collection of vibrant promo videos featuring charismatic characters — from a Turkish ice cream vendor and an airplane pilot to a levitating monk — each uniquely highlighting the advantage of instant global eSIM activation with the Uzbek operator ESIMETA.<br/><br/><a href="https://www.instagram.com/esimeta.uz/" target="_blank" rel="noopener noreferrer" style="text-decoration: underline;">Brand Instagram</a>'
    }
  },
  { 
    id: 6, 
